...
namespace Terminal.Dialogs {
    public class ColorPreferences : Gtk.Dialog {
        ...
        construct {
            get_content_area ().add (get_colors_box ());
        ...
        private Gtk.Widget get_colors_box () {
            ...
            var window_theme_label = new SettingsLabel (_("Window Theme"));
            ...
            var window_theme_switch = new Granite.ModeSwitch.from_icon_name (light_theme_icon, dark_theme_icon) {
                primary_icon_tooltip_text = _("Light window theme"),
                secondary_icon_tooltip_text = _("Dark window theme")
            };
            ...
            var console_theme_label = new SettingsLabel (_("Console Theme"));
            ...
            var grey_color_label = new SettingsLabel (_("Grey"));
            ...
            colors_grid.attach (new Granite.HeaderLabel (_("Themes")), 0, 0, 3);
