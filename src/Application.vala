...
public class Terminal.Application : Gtk.Application {
    ...
    protected override void startup () {
        ...
        set_accels_for_action (MainWindow.ACTION_PREFIX + MainWindow.ACTION_ZOOM_DEFAULT, TerminalWidget.ACCELS_ZOOM_DEFAULT);
        set_accels_for_action (MainWindow.ACTION_PREFIX + MainWindow.ACTION_ZOOM_IN, TerminalWidget.ACCELS_ZOOM_IN);
        set_accels_for_action (MainWindow.ACTION_PREFIX + MainWindow.ACTION_ZOOM_OUT, TerminalWidget.ACCELS_ZOOM_OUT);
    }
